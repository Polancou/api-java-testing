...
namespace ApiBaseCore.Api
{
    ...
    /// de integración (ApiBaseCore.Api.IntegrationTests) pueda descubrir y arrancar la API en memoria.
    /// </summary>
