...
public interface IProfileService
{
    ...
    Task<PerfilUsuarioDto> GetProfileByIdAsync(Guid userId);
    ...
    Task<bool> ActualizarPerfilAsync(Guid userId, ActualizarPerfilDto perfilDto);
    ...
    Task<AuthResult> CambiarPasswordAsync(Guid userId, CambiarPasswordDto dto);
